...
export default (ctx, inject) => {
  ...
  const prefixUrl = process.browser
      ? (runtimeConfig.browserBaseURL || 'https://ireporter-endpoint.herokuapp.com/api/v2/')
      : (runtimeConfig.baseURL || process.env._HTTP_BASE_URL_ || 'https://ireporter-endpoint.herokuapp.com/api/v2/')
